...
`https://github.com/Irish-bee/listen.git`
***
### Init Project
* `cd listen`
* `make init`
...
#### Synchronization Node(common node)
`./Listen --chain staging`
#### Node For Validator
...
# LICENSE
* All utilities are licensed under [Apache 2.0](LICENSE-APACHE2)
* Some of our code comes from [Substrate](https://github.com/paritytech/substrate), and we respect and abide by their open source protocol.
