...
pub fn listen_dev_config() -> Result<ChainSpec, String> {
	ChainSpec::from_json_bytes(&include_bytes!("../res/dev.json")[..])
}
...
fn development_config_genesis() -> GenesisConfig {
	testnet_genesis(
		...
		vec![hex!["a0921eeb61d94111a26536f0218a53055e5c19d970e4f9cf51167437adf86860"].into(),],
...
pub fn development_config() -> ChainSpec {
	...
	ChainSpec::from_genesis(
		...
		vec![],
		// vec![String::from("/ip4/47.106.196.14/tcp/30334/p2p/12D3KooWD7gZY33vYDmHhG5YxuPXktraa9EgXfJa3KzqJaAYP1pN").into().unwrap()],
		Some(TelemetryEndpoints::new(vec![(STAGING_TELEMETRY_URL.to_string(), 0)])
			.expect("Staging telemetry url is valid; qed")),
		// None,
		None,
